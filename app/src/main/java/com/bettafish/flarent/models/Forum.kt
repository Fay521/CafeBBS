...
class Forum {
    ...
    @JsonProperty("canStartPolls")
    var canStartPolls: Boolean? = null

    @JsonProperty("canStartGlobalPolls")
    var canStartGlobalPolls: Boolean? = null

    @JsonProperty("canUploadPollImages")
    var canUploadPollImages: Boolean? = null

    @JsonProperty("pollMaxOptions")
    var pollMaxOptions: Int? = null
